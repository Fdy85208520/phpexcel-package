...
namespace MillionMile\PHPSpreadsheet;

use MillionMile\PHPSpreadsheet\core\Export;
use MillionMile\PHPSpreadsheet\extend\export\Title\BigTitle;
use MillionMile\PHPSpreadsheet\extend\export\Cache\CaChe;
use MillionMile\PHPSpreadsheet\extend\export\Title\DoubleTitle;
...
class ExportService
{
     ...
     */
    public function setBigTitle(string $titleStr,$style=null)
    {
        $headerData = $this->export->getHeaderData();
        $bigTtielObj = new BigTitle(count($headerData));
        $bigTtielObj->setBigTitle($titleStr,$style);
    }
